"""
Phase 6.6 Step 3: Model Fitting with JAX (FAST)

Uses JAX/NumPyro for fast sampling.
"""
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("PHASE 6.6 Step 3: Model Fitting (JAX)")
    print("=" * 60)
    ...
    # Configure model
    print("\n2. Fitting model with JAX/NumPyro...")
    ...
    import time
    start = time.time()
    model.fit(data, use_jax=True)  # JAX sampling!
